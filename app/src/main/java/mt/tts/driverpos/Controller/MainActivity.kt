...
class MainActivity : BaseActivity() {
    ...
    fun displayActive()
    {
        ...
        {
            var cust = DSC[DSCpos]
            scr_01_DistName.text = cust.ClientCode + " - Qty: " + cust.Litres + "\n" + cust.Address

            if (cust.Qty > 0)
                scr_01_Qty_text.setText(cust.Qty.toString())
            else
                scr_01_Qty_text.setText("") //show blank instead of 0
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scr_01_Print_Btn.setOnClickListener {
            ...
            if (DSC[DSCpos].Locked)
            {
                ...
                val gasQty = scr_01_Qty_text.text.toString()
        ...
        scr_01_next_Btn.setOnClickListener {
        ...
        scr_01_prev_Btn.setOnClickListener {
            if (DSCpos > 0)
            {
                DSCpos--
                displayActive();
        ...
        scr_01_find_Btn.setOnClickListener {
            val serstr = scr_01_Search_text.text.toString()
